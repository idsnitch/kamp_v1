 ...
 * @UniqueEntity(fields={"email"},message="You have already registered. Thank you being part of KAMP")
 */
class User implements UserInterface
{
    ...
    private $password;
    /**
     * @Assert\NotBlank(message="Provide a valid Password. Password and Repeat Password must match")
     */
