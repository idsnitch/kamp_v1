...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    {
        $isLoginSubmit = ($request->getPathInfo() == '/login/' || $request->getPathInfo() == '/login/admin' || $request->getPathInfo() == '/login/profile') && $request->isMethod('POST');
    ...
    protected function getLoginUrl()
    {
        if ($this->redirectFailureUrl==""){
            $this->redirectFailureUrl="login-profile";
        }
