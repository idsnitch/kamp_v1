...
<head>
    ...
    $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, owl.carousel.css, owl.theme.css, custom.css') // CSS Files
        ->addJS('bootstrap.min.js, owl.carousel.js') // JS Files
...
<body class="contentpane popup-quick-view <?php echo $this->direction; ?>">
