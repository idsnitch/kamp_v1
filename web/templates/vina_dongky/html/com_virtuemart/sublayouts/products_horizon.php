									...
									<div class="btn-actions">
										...
										<div class="btn-groups">																			
											...
											<div class="btn-group btn-details<?php echo $detail_class;?>">										
												...
												echo JHtml::link($link.$ItemidStr,'<i class="simple-magnifier" aria-hidden="true"></i><span>'.vmText::_ ( 'COM_VIRTUEMART_PRODUCT_DETAILS' ).'</span>', array ('title' => vmText::_ ( 'COM_VIRTUEMART_PRODUCT_DETAILS' ), 'class' => 'product-details jutooltip' ) );				
												?>
											</div>
										</div>																	
									</div>
