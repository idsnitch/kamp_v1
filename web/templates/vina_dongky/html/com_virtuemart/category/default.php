		...
		<div id="vm-products-category" class="browse-view">
			...
			<div class="orderby-displaynumber">
				<div class="view-mode pull-left">
					<a href="javascript:viewMode('grid');" class="mode-grid <?php echo  ($this->productsLayout == 'products') ? 'active' : ''; ?>" title="Grid"><span aria-hidden="true" data-icon="&#xe06a;"></span></a>
					<a href="javascript:viewMode('list');" class="mode-list	<?php echo  ($this->productsLayout == 'products_horizon') ? 'active' : ''; ?>" title="List"><span aria-hidden="true" data-icon="&#xe067;"></span></a>
				</div>
