...
<div class="entry-image intro-image">
	...
	<div class="img-circle intro-publish-date major_color">
		<span class="intro-day"><?php echo JHtml::_('date', $displayData->publish_up, JText::_('d'));?></span>
		<span class="intro-month"><?php echo JHtml::_('date', $displayData->publish_up, JText::_('M Y'));?></span>
	</div>
</div>
<?php } ?>
