					...
					<div class="media-body">
						<div class="text-block">
							...
							<div class="info">
								...
								<span class="date"><?php //echo JTEXT::_('VINA_PUBLISHED'); ?> <?php echo JHTML::_('date', $created, 'F d, Y');?></span>
								<?php endif; ?>
								
								<?php if($showCategory) : ?>
								<span class="cat"><?php //echo JTEXT::_('VINA_CATEGORY'); ?> <?php echo $category; ?></span>
								<?php endif; ?>
								
								<?php if($showHits) : ?>
								<span class="hits"><?php //echo JTEXT::_('VINA_HITS'); ?> <?php echo $hits; ?></span>
								<?php endif; ?>
							</div>
							<?php endif; ?>
