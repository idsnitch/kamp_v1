...
?>
<h4><?php echo JText::_('VINA_LEAVE_A_COMMENT'); ?></h4>
<?php
...
<?php
		...
		if ($this->getVar( 'comments-form-user-name', 1) == 1) {
			...
			$text = ($this->getVar('comments-form-user-name-required', 1) == 0) ? JText::_('FORM_NAME') : JText::_('FORM_NAME').' *';
?>
<div class="col-sm-<?php echo 12/$getVarcount; ?>">
	<span>
		<input id="comments-form-name" placeholder="<?php echo $text; ?>" type="text" name="name" value="" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" />
		<label class="hidden" for="comments-form-name"><?php echo $text; ?></label>
	</span>
</div>
<?php
		}
		if ($this->getVar( 'comments-form-user-email', 1) == 1) {
			...
			$text = ($this->getVar('comments-form-email-required', 1) == 0) ? JText::_('FORM_EMAIL') : JText::_('FORM_EMAIL'). ' *';
?>
<div class="col-sm-<?php echo 12/$getVarcount; ?>">
	<span>
		<input id="comments-form-email" placeholder="<?php echo $text; ?>" type="text" name="email" value="" size="22" tabindex="2" />
		<label class="hidden" for="comments-form-email"><?php echo $text; ?></label>
	</span>
</div>
<?php
		}
		if ($this->getVar('comments-form-user-homepage', 0) == 1) {
			...
			$text = ($this->getVar('comments-form-homepage-required', 1) == 0) ? JText::_('FORM_HOMEPAGE') : JText::_('FORM_HOMEPAGE') . ' *';
?>
<div class="col-sm-<?php echo 12/$getVarcount; ?>">
	<span>
		<input id="comments-form-homepage" placeholder="<?php echo $text; ?>" type="text" name="homepage" value="" size="22" tabindex="3" />
		<label class="hidden" for="comments-form-homepage"><?php echo $text; ?></label>
	</span>
</div>
<?php
		}
		if ($this->getVar('comments-form-title', 0) == 1) {
			...
			$text = ($this->getVar('comments-form-title-required', 1) == 0) ? JText::_('FORM_TITLE') : JText::_('FORM_TITLE') . ' *';
?>
<div class="col-sm-12">
	<span>
		<input id="comments-form-title" placeholder="<?php echo $text; ?>" type="text" name="title" value="" size="22" tabindex="4" />
		<label class="hidden" for="comments-form-title"><?php echo $text; ?></label>
	</span>
</div>
<?php
		}
...
<div class="col-sm-12">
	<span>
		<textarea placeholder="<?php echo JText::_('VINA_MESSAGE'); ?>" id="comments-form-comment" name="comment" cols="65" rows="8" tabindex="5"></textarea>
	</span>
</div>
<?php
...
<div class="col-sm-12">
	<div id="comments-form-buttons">
		<div  id="comments-form-send"><div><a class="btn" href="#" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>"><?php echo JText::_('FORM_SEND'); ?></a></div></div>
