...
?>
<div id="vina-carousel-content<?php echo $module->id; ?>" class="vina-carousel-content style-1 owl-carousel <?php echo $classSuffix; ?>">
	<!-- Items Block -->
	<?php
			...
			<div class="blog-inner">
				...
				<div class="text-block">
					...
					<div class="img-circle intro-publish-date major_color">
						...
						<span class="intro-month"><?php echo JHtml::_('date', $created, JText::_('M Y'));?></span>
					</div>
					<?php endif; ?>
