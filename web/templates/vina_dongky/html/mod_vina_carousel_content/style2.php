...
?>
<div id="vina-carousel-content<?php echo $module->id; ?>" class="vina-carousel-content style-2 owl-carousel <?php echo $classSuffix; ?>">
	<!-- Items Block -->
	<?php
					...
					<?php if($showImage && isset($images)) { ?>				
						<div class="image-block">
							<div class="entry-image">
								...
								<div class="actions">
									<div class="btn-buttons">								
										...
										<a href="<?php echo $link; ?>" title="<?php echo JText::_( 'VINA_DETAIL' ); ?>" class="btn-button btn-quickview jutooltip">
							...
							<div class="img-circle intro-publish-date major_color">
								<span class="intro-day"><?php echo JHtml::_('date', $created, JText::_('d M'));?></span>
								<span class="intro-month"><?php echo JHtml::_('date', $created, JText::_('Y'));?></span>
							</div>
							<?php endif; ?>
						</div>
					<?php } ?>
