		...
		'attr'=>array(
			...
			'repetable_item'=>array(
				...
				'attr'=>  array(
					...
					'position'=>array(
						'type'=>'select', 
						'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_PRO_POSITION'),
						'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_PRO_POSITION_DESC'),
						'values'=>array(
							'before'=>JText::_('COM_SPPAGEBUILDER_ADDON_GLOBAL_BEFORE'),
							'after'=>JText::_('COM_SPPAGEBUILDER_ADDON_GLOBAL_AFTER'),
							),
						'std'=>'before',
						),
					'message'=>array(
