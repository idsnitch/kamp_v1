...
function sp_cout_down_addon($atts){
	...
	if($image && $title) {
		...
		if($text) $output .= '<div class="sppb-image-content-text">' . $text . '</div>';
		...
		if($button_text) {
			$output .= '<a' . $button_target . ' href="' . $button_url . '" class="sppb-btn sppb-btn-' . $button_type . ' sppb-btn-' . $button_size . ' ' . $button_block . '" role="button">' . $button_text . '</a>';
		}
