...
$body_classes .= ( ! $this->helix3->getParam('vm_product_labels', 1)) ? ' hide-vmproduct-labels' : '';
$body_classes .= ( ! $this->helix3->getParam('vm_quickview', 1)) ? ' hide-vmquickview' : '';
...
<head>
    ...
    $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, simple-line-icons.css, material-design-iconic-font.min.css, owl.theme.css, animate.min.css, owl.carousel.css, material-design-iconic-font.min.css') // CSS Files
        ->addJS('bootstrap.min.js,jquery.countdown.min.js, jquery.sticky.js, main.js, owl.carousel.js, bootstrap-select.min.js, template.js') // JS Files
        ->lessInit()->setLessVariables(array(
			...
			'lblnew_color'=> $this->helix3->PresetParam('_lblnew'),
			'lblsale_color'=> $this->helix3->PresetParam('_lblsale')
            ))
