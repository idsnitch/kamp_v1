...
SpAddonsConfig::addonConfig(
	array(
		...
		'attr'=>array(
			...
			'position'=>array(
				'type'=>'select', 
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_PROGRESS_BAR_POSITION'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_PROGRESS_BAR_POSITION_DESC'),
				'values'=>array(
					'inside'=>JText::_('COM_SPPAGEBUILDER_ADDON_GLOBAL_INSIDE'),
					'outside'=>JText::_('COM_SPPAGEBUILDER_ADDON_GLOBAL_OUTSIDE'),
					'initial'=>JText::_('COM_SPPAGEBUILDER_ADDON_GLOBAL_INITIAL'),
					),
				'std'=>'initial',
				),
			'text'=>array(
