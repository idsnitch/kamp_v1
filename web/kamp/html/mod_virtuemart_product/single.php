...
<div class="vmgroup<?php echo $params->get ('moduleclass_sfx') ?>">
	...
	<?php if ($display_style == "div") { ?>		
		...
		<ul class="mage-products vmproduct<?php echo $params->get ('moduleclass_sfx'); ?> productdetails">
			<?php foreach ($products as $product) :
				$stock  = $productModel->getStockIndicator($product);
				$sLevel = $stock->stock_level;
				$sTip   = $stock->stock_tip;
		...
		<div class="clear"></div>
		<ul class="mage-products vmproduct' . $params->get ('moduleclass_sfx') . ' productdetails">';
				$col = 1;
			} else {
				$col++;
			}
