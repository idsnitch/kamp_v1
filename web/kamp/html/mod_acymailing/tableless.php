			...
			<div class="acymailing_form">
				...
				<?php }
				 ...
				 if($params->get('showterms',false)){
					...
					<div class="acysubbuttons <?php echo strpos($params->get('subscribetext') , 'fa')===false ? '' : 'style-icon'; ?>">
						<?php 
							if(strpos($params->get('subscribetext'), 'fa')===false){
								$subtexthtml = "";
							}else {
								$subtexthtml = '<i class="fa fa-long-arrow-right"></i>';
							}
						?>
