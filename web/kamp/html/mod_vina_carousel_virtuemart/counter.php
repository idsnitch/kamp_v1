...
<div id="vina-carousel-virtuemart<?php echo $module->id; ?>" class="vina-carousel-virtuemart owl-carousel has-counter">
	...
	<div class="item product-i">
		<div class="product-inner item-inner">
			<?php 
				...
				<div class="item-i-inner">
					...
					<div class="text-block">
						...
						<div class="actions">
							...
							<?php if( $viewDetails || is_dir(JPATH_BASE."/components/com_wishlist/") ) : ?>
	...
	if( $('[data-countdown]').length ) {
		$('[data-countdown]').each(function() {
			...
			$this.countdown(finalDate, function(event) {
				$this.html(event.strftime('<div class="hour box-time-date"><span class="number">%H </span>Hrs</div><div class="min box-time-date"><span class="number"> %M</span> Mins</div> <div class="sec box-time-date"><span class="number">%S </span>Secs</div><div class="day box-time-date"><span class="number">%D </span>Days</div>'));
			});
		});
	}
